...
/**
 * Test class for the InsertionSort class.
 *
 * @author marylene
 * @since 11 April 2019
 */
public class InsertionSortTest {
     ...
     *
     * @covers coffeesort.InsertionSort.insertionSortSwapping()
     */
    public void testInsertionSortSortSwapping() {
        System.out.println("insertionSortSwapping");
        ...
        while (scenarios.hasNext()) {
            ...
            InsertionSort.insertionSortSwapping(array);

            Assert.assertArrayEquals(
                "The insertion sort by swapping result was expected to equal the expected result",
                expResult,
                array
            );
        }
     ...
     *
     * @covers coffeesort.InsertionSort.insertionSortShifting()
     */
     public void testInsertionSortShifting() {
        System.out.println("insertionSortShifting");
        ...
        while (scenarios.hasNext()) {
            ...
            int[] expResult = scenario[0];
            int[] array = scenario[1];
            InsertionSort.insertionSortShifting(array);
            
            Assert.assertArrayEquals(
                "The insertion sort by shifting result was expected to equal the expected result",
                expResult,
                array
            );
        }
