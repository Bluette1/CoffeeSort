...
/**
 * Test class for the MergeSort class.
 *
 * @author marylene
 * @since 11 April 2019
 */
public class MergeSortTest {
    ...
    @Test
    /**
     * This will test that the given array is sorted correctly using merge sort
     *
     * @covers coffeesort.MergeSort.mergeSort()
     */
     public void testMergeSort() {
        ...
        while (scenarios.hasNext()) {
            ...
            Assert.assertArrayEquals(
                "The merge sort result was expected to equal the expected result",
                expResult,
                array
            );
        }
